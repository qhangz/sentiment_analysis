...
#     }
#
#     response = requests.get('https://www.bilibili.com/video/' + bv, headers=headers)
#     content = response.text
#
#     cid = re.findall(r'"cid":(\d+),', content)
#     if cid:
#         cid = cid[0]
#         xml_url = f'https://comment.bilibili.com/{cid}.xml'
#         return xml_url
#     else:
#         print("未找到 cid，请检查视频链接是否正确。")
#         return None
...
def getBinVisualize_(url, segment=15, save=False, savepath=None):
    ...
    # print('time barrage:', time_barrage)
    # print('time_barragep[time]:', time_barrage['time'])
