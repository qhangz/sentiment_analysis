...
# 主函数
def demo(url, segment=15, mask=False, resultpath=None):
    '''
    舆情分析主函数。
...
if __name__ == '__main__':
    ...
    # url='https://www.bilibili.com/video/BV1Hm421W7fP/?spm_id_from=333.1007.tianma.1-1-1.click&vd_source=2c028219bde53dd725fd2b228dc2d5df'

    resultpath = './analysis_result'

    # 运行主函数
    demo(url, segment=15, mask=False, resultpath=resultpath)
